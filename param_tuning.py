...
def tuning_iride(path, game):
    output = [np.array([[get_mean_return_from_dict(load_slurm_output(path + "round" + str(i) + "/", game + "_iride_gpu_ilc_" + j + "_ecc_" + z + ".out", 51))
...
# tuning_iride("data/coinrun/iride/parameter/", "cr")
print("jumper:")
...
# tuning_iride("data/jumper/iride/parameter/", "jp")
print("leaper:")
...
# tuning_iride("data/leaper/iride/parameter/", "lp")
print("ninja")
...
tuning_iride("data/ninja/iride/parameter/", "nj")
